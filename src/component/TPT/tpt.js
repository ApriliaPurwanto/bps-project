...
const TPT = () => {
    ...
    return (    
        <div className="all-main-page6">
            <div className="layout-margincontainer6">
                <div className="title">
                ...
                <div className="container6">
                    <div className="definisi">
                        <ul>
                    	<li><p><b>Penganggur terbuka, terdiri dari:</b></p></li>
                        <ol>
                            <li>Mereka yang tak punya pekerjaan dan mencari pekerjaan.</li>
                            <li>Mereka yang tak punya pekerjaan dan mempersiapkan usaha.</li>
                            <li>Mereka yang tak punya pekerjaan dan tidak mencari pekerjaan, karena merasa tidak mungkin mendapatkan pekerjaan.</li>
                            <li>Mereka yang sudah punya pekerjaan, tetapi belum molai bekerja.</li>
                        </ol>
                        <br/>
                        <li><p><b>TPT (Tingkat Pengangguran Terbuka)</b> adalah persentase jumlah pengangguran terhadap jumlah angkatan kerja.</p></li>
                        </ul>
                    </div>
