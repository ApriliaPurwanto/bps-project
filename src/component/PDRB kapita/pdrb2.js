...
const PDRBKapita = () => {
    ...
    return (    
        <div className="all-main-page11">
            <div className="layout-margincontainer11">
                <div className="title">
                ...
                <div className="container11">
                    <div className="definisi">
						{/* <p><b>PDRB PER KAPITA HARGA BERLAKU</b></p> */}
                        <p>Bila pendapatan regional ini dibagi dengan jumlah penduduk yang tinggal di daerah itu, maka akan dihasilkan suatu Pendapatan Perkapita</p>
                    </div>
